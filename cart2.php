...
<td><a href="cart2.php?action=delete&id=<?php echo $values["food_id"]; ?>"><span class="text-danger">Remove</span></a></td>
</tr>
<?php 
...
if($count >0)
{
echo '<script>window.location="cart2.php";
alert("Added to cart");</script>';
}
}
else
{
