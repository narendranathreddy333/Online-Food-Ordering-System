...
<div class="container">
    <div class="container">
        ...
        <a href="feedback.php" class="list-group-item active">View Feedback</a>   
                  <a href="ordersum.php" class="list-group-item">Order Summaries</a>
    	</div>
    </div>
...
//WHERE f.R_ID IN (SELECT r.R_ID FROM RESTAURANTS r WHERE r.M_ID='$user_check') and f.options='ENABLE' ORDER BY F_ID";
